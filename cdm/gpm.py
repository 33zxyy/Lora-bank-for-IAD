...
class CDAD(SD_AMN):
    ...
    def __init__(self, lora_rank=4, lora_alpha=1.0, orth_lambda=1e-4, novelty_threshold=0.2,
                 ...
                 orth_constraint_mode="hard", adaptive_init_on_task0=False, router_topk=2,
                 ...
                 task0_max_new_experts_per_task=2,
                 control_lr=8e-5, lora_lr=8e-5, router_lr=1e-4,
                 conv_highres_rank=8, attn_middle_rank=4,
                 *args, **kwargs):
